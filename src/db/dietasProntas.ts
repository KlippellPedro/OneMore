...
export const DIETAS_PRONTAS: DietaPronta[] = [
  {
    ...
    apelido: 'Metodo Hibrido - Edicao 01',
    resumo: '~2.800 kcal em 3 refeicoes grandes, com comida barata de mercado.',
    porque:
      'A aposta e praticidade: tres refeicoes, nenhum alimento caro e nada que precise '
      + 'de preparo complicado. Arroz, cuscuz, pao, ovo, sobrecoxa e macarrao seguram '
      + 'cerca de 155 g de proteina e 285 g de carboidrato sem voce cozinhar seis vezes '
      + 'por dia. Se comer mais vezes te atrapalha mais do que ajuda, esse formato ganha '
      + 'do plano de 7 refeicoes no unico criterio que decide dieta: o que voce consegue '
      + 'repetir por meses. A regra fixa do metodo e encaixar uma fruta em cada refeicao.',
    cuidado:
      ...
      + 'madrugada. Se voce for testar, quebre a janta em duas (jantar e ceia) e meca '
      + 'antes de dormir e na madrugada nos primeiros dias. Fora isso: 3 refeicoes deixam '
      + 'cerca de 250 kcal a menos que o seu plano atual e cortam boa parte das verduras, '
      + 'frutas e laticinios - a fruta por refeicao nao e enfeite, e o que fecha a conta.',
    refeicoes: [
      {
        nome: 'Cafe da manha', horario: '07:00',
        nota: 'Opcao 2: 3 paes frances + 3 fatias de queijo + 3 ovos. Encaixe uma fruta.',
        itens: [
      ...
      },
      {
        ...
        nota:
          'Opcao 2: 200 g de macarrao + 120 g de sobrecoxa. Opcao 3: 120 g de goma de '
          + 'tapioca + 120 g de sobrecoxa + salada. A salada e a vontade - o alface e o '
          + 'tomate aqui sao so o minimo pra conta nao ficar zerada.',
        itens: [
      ...
      },
      {
        ...
        nota: 'Opcao 2: repetir o almoco - e a versao mais leve e mais facil de dosar insulina.',
        itens: [
